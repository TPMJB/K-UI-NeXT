...
def main():
    ...
    (update / "SOURCE.txt").write_text(
        ...
        "Start with APPS-ROUND-FOUR.md for the new controls. See APPS-TEST.md for this app round and RIPPER-CONTROLS.md for destinations, named dumps and CRC results.\n"
